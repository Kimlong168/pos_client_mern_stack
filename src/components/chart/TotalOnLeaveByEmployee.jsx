...
export default function TotalOnLeaveByEmployee({ data }) {
  ...
  return (
    <Card>
      <CardHeader>
        ...
        <CardDescription>
          Total on leave amount by each employee for this month
        </CardDescription>
      </CardHeader>
      <CardContent>
...
TotalOnLeaveByEmployee.propTypes = {
